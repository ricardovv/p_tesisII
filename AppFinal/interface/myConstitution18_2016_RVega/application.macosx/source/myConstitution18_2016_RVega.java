...
public class myConstitution18_2016_RVega extends PApplet {
...
//TITLES BAR TOP
public void panelTitles(String _title1, String _title2, int _posx, int _posy) {
  float tW = textWidth(_title1);
  pushMatrix();
    fill(  0xff4B0082);//WHITE
    rectMode(CORNER);
...
//  int menuY = int(visualPosY - boxChapterH);//position from top
  int menuY = PApplet.parseInt(visualPosY);//position from top
...
//  questions(gridUnit*14, -10, 2);
  ...
  visualizationLabels( gridUnit*38, gridUnit*2 );
  chaptersTopDisplay();
...
//ver displace
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#02232C", "--hide-stop", "myConstitution18_2016_RVega" };
    if (passedArgs != null) {
