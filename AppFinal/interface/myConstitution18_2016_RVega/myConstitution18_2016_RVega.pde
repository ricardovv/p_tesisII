...
int articleBoxW = gridUnit*2 + gridUnit/2;//42 Articles box width, 35-45 optimal
...
//color cajasCrossReference = color(50, 205, 50);
color cajasCrossReference = color(50, 205, 50);
...
void draw() {
  ...
  if (section == 2) {
    questions(gridUnit*12, gridUnit+10, 2);
    panelTopics();
//    panelTitles("TOPICS");
    panelTitles("My Constitution", "Exploring the Chilean Constitution of 1980", 10+gridUnit*2, gridUnit+8);
